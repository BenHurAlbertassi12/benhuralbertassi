  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          Especialista em Big Data, Python, Spark e Azure, atualmente na EloGroup, 
          transformando dados complexos em soluções estratégicas para negócios.
        </motion.p>
      ...
      >
        <ChevronDown className="text-white/60 hover:text-white transition-colors" size={32} />
      </motion.div>
    </section>
  );
};
